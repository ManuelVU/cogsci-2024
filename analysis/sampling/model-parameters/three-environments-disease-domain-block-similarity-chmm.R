...
saveRDS(object = samples, 
        file = "data/posterior-samples/three-environments-posterior-samples-block-1-similarity.rds")
...
# Save posterior samples
saveRDS(object = samples, 
        file = "data/posterior-samples/three-environments-posterior-samples-block-2-similarity.rds")
...
# Save posterior samples
saveRDS(object = samples, 
        file = "data/posterior-samples/three-environments-posterior-samples-block-3-similarity.rds")
...
# Save posterior samples
saveRDS(object = samples, 
        file = "data/posterior-samples/model-parameters/three-environments-posterior-samples-block-4-similarity-chmm-3param.rds")
